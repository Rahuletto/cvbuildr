    ...
    <>
      ...
      <div className="print:hidden exclude-print z-20 fixed bottom-10 right-10 h-auto flex gap-2 items-center justify-end">
        <button
          onClick={() => save()}
          disabled={saving !== 0}
          className={`rounded-xl px-6 py-2 disabled:opacity-70 backdrop-blur-sm disabled:border-dashed border-2 border-black bg-black active:shadow-active transition-all duration-300 hover:shadow-hover disabled:hover:shadow-none disabled:active:shadow-none font-semibold ${
            saving === 2
              ? "bg-green-500 text-black backdrop-blur-sm"
              : saving === 3
              ? "bg-red-500 text-black backdrop-blur-sm"
              : "bg-black text-white"
          }`}
          style={{
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="col-span-1 space-y-2">
                ...
                {resumeData.workExperience.length <= 3 && (
                  <Droppable
                    direction="vertical"
                    ignoreContainerClipping
                    isCombineEnabled={true}
