          ...
          scale-100 translate-y-0`}
            ...
            <div className="print:hidden exclude-print z-20 fixed bottom-10 right-10 h-auto flex gap-2 items-center justify-end">
                <button
                    onClick={() => save()}
                    disabled={saving !== 0}
                    className={`rounded-xl px-6 py-2 disabled:opacity-70 disabled:border-dashed border-2 border-black bg-black active:shadow-active transition-all duration-300 hover:shadow-hover disabled:hover:shadow-none disabled:active:shadow-none font-semibold ${saving === 2
                ...
                <A4PageWrapper>
                    <DragDropContext onDragEnd={onDragEnd}>
                        <div className="f-col mb-1">
                            <div className="flex flex-row gap-4 mt-2 items-center  mb-4">
                                ...
                                <div className="flex f-col">
                                    <h1 className="name !text-4xl">{resumeData.name}</h1>
                                    <p className="profession">{resumeData.position}</p>
                                </div>
                            </div>
                            <ContactInfo
                                mainclass="flex flex-row gap-3 mb-1 contact"
                                    ...
                                    resumeData.socialMedia.map((socialMedia, index) => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="inline-flex items-center gap-1 social-media align-center justify-center w-fit"
                                            >
                                                {icons.find(
                                                    (a) =>
                        ...
                        <hr className="border-dashed my-2 mb-4" />
                        {resumeData.summary.length > 0 && (
                            <div className="mb-8">
                                <h2 className="section-title mb-1 border-b-2 !text-2xl !text-cyan-700 border-gray-300">
                                    Summary
                                </h2>
                            ...
                            <div className="col-span-1 space-y-2">
                                <div>
                                    {resumeData.education && resumeData.education.length > 0 && (
                                        <div className="mb-1">
                                            <h2 className="section-title mb-1 border-b-2 !text-cyan-700 border-gray-300">
                                                Education
                                            </h2>
                                        ...
                                        resumeData.workExperience.length > 0 && (
                                            ...
                                            >
                                                {(provided) => (
                                                    ...
                                                    >
                                                        <h2
                                                            className="section-title mb-1 !text-cyan-700 border-b-2 border-gray-300 editable"
                                                            contentEditable
                                ...
                                <Droppable droppableId="skills" type="SKILLS">
                                    {(provided) => (
                                        <div {...provided.droppableProps} ref={provided.innerRef} className="grid-cols-2 grid gap-3">
                                                ...
                                                >
                                                    {(provided, snapshot) => (
                                                        <div
                                                            ...
                                                            className={`mb-1 ${snapshot.isDragging &&
                                                                "outline-dashed outline-2 outline-gray-400 bg-white"
                                                                } ${index == resumeData.skills.length - 1 ? "col-span-2" : ""}`}
                                                        >
                                                            <Skills
                                                                hclass="!text-cyan-700"
                                                                ptype="list"
                                                                title={skill.title}
                                                                skills={skill.skills ?? []}
                                                            />
                                                            ...
                                                            >
                                                                <div className="flex flex-row justify-between space-y-1">
                                                                    <Link
                                                                        ...
                                                                        className="content i-bold underline text-blue-500"
                                                                    >
                                                                        {item.name}
                                                                    </Link>
                                                                    <DateRange
