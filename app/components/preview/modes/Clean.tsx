...
const CleanPreview = () => {
  ...
  return (
    <>
      ...
      <div className="lg:max-w-[50%] w-full h-fit min-h-screen sticky top-0 preview rm-padding-print bg-white border-l border-black print:border-l-0 print:absolute print:top-0 print:left-0 print:w-screen print:min-h-screen">
        <A4PageWrapper>
          {mounted && (
