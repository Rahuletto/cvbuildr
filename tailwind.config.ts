...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        shimmerGradient:
          "linear-gradient(90deg, #9333EA 25%, black 50%, #6366F1 75%)",
        shimmerWhite: "linear-gradient(90deg, white 25%, black 50%, white 75%)",
      },
      animation: {
        fadeIn: "fadeIn 0.25s ease-out forwards",
        opacityFade: "opacityFade 0.25s ease-out forwards",
        cursor:
          "cursor 1.7s cubic-bezier(0.19, 1, 0.22, 1) forwards, hovering 6s infinite",
        shapeShift:
          "shapeShift 3s cubic-bezier(0.19, 1, 0.22, 1) forwards infinite",
      ...
      keyframes: {
        ...
        shimmer: {
          ...
          "50%": {
            backgroundPosition: "200% 0",
            backgroundImage:
              "linear-gradient(90deg, #6366F1 25%, black 50%, #9333EA 75%)",
            opacity: "1",
